...
//#dhtmlxtootip:01112006{
				  	  if (dhtmlObject._dhxTT) dhtmlxTooltip.setTooltip(newNode.span.parentNode.parentNode,tooltip);
					  else
//#}
//#}
                   ...
                   if (node.childNodes[i].childNodes.length>0) {
                      for (var a=0; a<node.childNodes[i].childNodes.length; a++)
                        if (node.childNodes[i].childNodes[a].tagName=="item"){
						   	if (!newNode.childsCount) newNode.unParsed=node.childNodes[i];
						}
                        else
...
//#smart_parsing:01112006{
          if ((dhtmlObject.slowParse)&&(dhtmlObject.parsingOn==dhtmlObject.rootId))
            {
            var nodelist=xml_obj.doXPath("//item[@open]",xml_obj.xmlDoc.responseXML||xml_obj.xmlDoc);
...
//#}
         ...
         if ((!dhtmlObject._edsbps)||(!dhtmlObject._edsbpsA.length)){
                if (dhtmlObject.onXLE) {
					var z_call=dhtmlObject.onXLE;
                 	window.setTimeout( function(){z_call(dhtmlObject,parentId)},1);
				 }
...
//#on_open_end_event:11052006{
      dhtmlXTreeObject.prototype._epnFHe=function(that,id,flag){
        ...
        if ((!flag)&&(that.onXLE)) that.onXLE(that,id);
    }
...
//#__pro_feature:01112006{
//#dhtmlxtootip:01112006{
	  	  if (this._dhxTT) dhtmlxTooltip.setTooltip(tr,itemObject.label);
		  else
//#}
//#}
...
*/
   dhtmlXTreeObject.prototype.setOnSelectStateChange=function(func){  if (typeof(func)=="function") this._onSSCF=func; else this._onSSCF=eval(func);  };
...
*/ 
   dhtmlXTreeObject.prototype._openItem=function(item){ 
		   ...
		   if ((state<0)||(((this.XMLsource)&&(!item.XMLload)))){
	           if    ((this._spnFH)&&(!this._spnFH(item.id,state))) return 0;
...
*/
   dhtmlXTreeObject.prototype.smartRefreshItem=function(itemId,source){
		...
		if ((source)&&(source.tagName))
			this._parseXMLTree(this,source,itemId);
		else
